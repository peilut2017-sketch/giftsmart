    ...
    <div className="flex-1" style={{ background: 'var(--c-bg)' }}>
      ...
      <div className="legal-doc max-w-2xl mx-auto px-5 py-6 pb-28 space-y-8" dir="rtl">
        ...
        <Section title="8. פרטיות ילדים">
          <p>השירות אינו מיועד לילדים מתחת לגיל 16. אם נודע לנו שאספנו מידע ממשתמש מתחת לגיל זה, נמחק אותו לאלתר.</p>
        </Section>
        ...
        <Section title="10. בסיס משפטי לעיבוד מידע">
          <p>אנו מעבדים מידע אישי בהתבסס על:</p>
          <ul>
            <li><strong>ביצוע חוזה</strong> — עיבוד הנדרש לאספקת השירות שהזמנת (ניהול שוברים, שיתוף, שוק).</li>
            <li><strong>הסכמה</strong> — לשליחת תזכורות דוא"ל, שיתוף עם משפחה, ותכונות אופציונליות.</li>
            <li><strong>אינטרס לגיטימי</strong> — אבטחת השירות, מניעת הונאה, שיפור השירות.</li>
            <li><strong>חוק</strong> — עמידה בדרישות חוק הגנת הפרטיות, תשמ"א-1981, ותקנות GDPR ככל שיחולו.</li>
          </ul>
          <p className="mt-2">
            שימוש בשירות כפוף גם ל
            <a href="/terms" target="_blank" rel="noreferrer" className="text-green-600 underline font-medium mx-1">תנאי השימוש</a>
            שלנו.
          </p>
        </Section>

        <Section title="11. הגבלת אחריות בנוגע לנתונים">
          <p>GiftSmart נוקטת באמצעי אבטחה סבירים כמפורט לעיל, אך <strong>אינה יכולה להבטיח הגנה מלאה</strong> מפני כל מקרה של פריצה, דליפה, או שימוש לרעה בנתונים על ידי גורמים עוינים. בכפוף לדין הישראלי החל:</p>
          <ul>
            <li>GiftSmart לא תישא באחריות לנזקים עקיפים, תוצאתיים, או עונשיים הנובעים מאירוע אבטחה שאינו בשליטתה.</li>
            <li>GiftSmart לא תישא באחריות לנזקים הנובעים מנתונים שאבדו עקב שכחת סיסמת E2EE — נתונים אלה אינם ניתנים לשחזור.</li>
            <li>אחריות מצטברת מרבית לאירועי פרטיות מוגבלת לסכום ששולם לחברה ב-12 החודשים שקדמו לאירוע, או 100 ₪.</li>
          </ul>
        </Section>
